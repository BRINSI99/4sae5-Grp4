...
import tn.esprit.spring.JwtAndAuthConf.JwtResponse;
import tn.esprit.spring.JwtAndAuthConf.JwtUtils;
import tn.esprit.spring.JwtAndAuthConf.LoginRequest;
import tn.esprit.spring.JwtAndAuthConf.UserDetailsImpl;
...
public class UserControlleur {
    ...
    @DeleteMapping("/deletUser/{idUser}")
