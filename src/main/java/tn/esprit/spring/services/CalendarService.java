...
import tn.spring.repository.CalendarEventRepository;
import tn.spring.repository.CalendarRepository;
...
public class CalendarService {
	...
	public List<CalendarEvent> findByEventDateTimeBetween(LocalDateTime start, LocalDateTime end)
	{
		...
		return calendarEventRepository.findAllWithCreationDateTimeBefore(start, end);
	}
}
